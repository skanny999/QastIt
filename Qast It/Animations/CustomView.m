...
- (void)setupLayerFrames{
	...
	CAShapeLayer * mov7 = self.layers[@"mov7"];
	mov7.frame          = CGRectMake(0.09505 * CGRectGetWidth(mov7.superlayer.bounds), 0.09444 * CGRectGetHeight(mov7.superlayer.bounds), 0.18768 * CGRectGetWidth(mov7.superlayer.bounds), 0.18889 * CGRectGetHeight(mov7.superlayer.bounds));
